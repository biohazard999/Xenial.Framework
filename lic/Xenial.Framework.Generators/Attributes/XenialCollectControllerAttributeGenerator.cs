...
public record XenialCollectControllerAttributeGenerator(bool AddSources = true) : XenialAttributeGenerator(AddSources)
{
    public override string AttributeName => "XenialCollectControllerAttribute";

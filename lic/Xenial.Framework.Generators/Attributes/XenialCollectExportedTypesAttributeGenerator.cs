...
public record XenialCollectExportedTypesAttributeGenerator(bool AddSources = true) : XenialAttributeGenerator(AddSources)
{
    public override string AttributeName => "XenialCollectExportedTypesAttribute";

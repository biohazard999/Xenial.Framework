...
namespace Xenial.Licensing.Ext.Crypto.Digests
{
    ...
    /// sizes, based on the <see cref="Xenial.Licensing.Ext.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
    /// </summary>
    /// <remarks>
    ...
    /// <p/>
    /// This implementation is the basis for <see cref="Xenial.Licensing.Ext.Crypto.Digests.SkeinDigest"/> and <see cref="Xenial.Licensing.Ext.Crypto.Macs.SkeinMac"/>, implementing the
    /// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
    /// Initialising the engine with <see cref="Xenial.Licensing.Ext.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
    ...
    /// </ul>
    /// </remarks>
    /// <seealso cref="Xenial.Licensing.Ext.Crypto.Parameters.SkeinParameters"/>
        ...
        : IMemoable
    {
        ...
        /// <summary>
        /// Initialises the Skein engine with the provided parameters. See <see cref="Xenial.Licensing.Ext.Crypto.Parameters.SkeinParameters"/> for

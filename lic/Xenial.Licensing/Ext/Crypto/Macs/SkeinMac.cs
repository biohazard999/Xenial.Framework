...
namespace Xenial.Licensing.Ext.Crypto.Macs
{
	...
	/// based on the <see cref="Xenial.Licensing.Ext.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	/// <seealso cref="Xenial.Licensing.Ext.Crypto.Digests.SkeinEngine"/>
		...
		: IMac
	{
		...
		/// </summary>
		/// See <see cref="Xenial.Licensing.Ext.Crypto.Parameters.SkeinParameters"></see> for details on the parameterisation of the Skein hash function.

namespace Xenial.Licensing.Ext.Asn1.IsisMtt
{
	public abstract class IsisMttObjectIdentifiers
	{
		 ...
		 * </pre>
		 * 
		 * @see Xenial.Licensing.Ext.Asn1.IsisMtt.X509.Restriction
		 */
		 ...
		 * 
		 * @see Xenial.Licensing.Ext.Asn1.IsisMtt.Ocsp.RequestedCertificate
		 */
		 ...
		 *
		 * @see Xenial.Licensing.Ext.Asn1.IsisMtt.Ocsp.CertHash
		 */
		 ...
		 * 
		 * Used in
		 * {@link Xenial.Licensing.Ext.Asn1.X509.SubjectDirectoryAttributes SubjectDirectoryAttributes}
		 */
		 ...
		 * </pre>
		 * 
		 * @see Xenial.Licensing.Ext.Asn1.IsisMtt.X509.AdditionalInformationSyntax
		 */

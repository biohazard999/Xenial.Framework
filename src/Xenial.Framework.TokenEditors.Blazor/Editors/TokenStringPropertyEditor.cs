...
namespace Xenial.Framework.TokenEditors.Blazor.Editors
{
    ...
    /// <autogeneratedoc />
    [XenialCheckLicence]
    public sealed partial class TokenStringInputModel : ComponentModelBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [allow custom tags].
        /// </summary>
        /// <value><c>true</c> if [allow custom tags]; otherwise, <c>false</c>.</value>
        /// <autogeneratedoc />
        public bool AllowCustomTags { get => GetPropertyValue<bool>(); set => SetPropertyValue(value); }
    ...
    /// <autogeneratedoc />
    [XenialCheckLicence]
    public sealed partial class TokenStringComponentAdapter : ComponentAdapterBase
    {
        /// <summary>

...
namespace Xenial.Framework.TokenEditors.Win.Editors
{
    ...
    public class TokenObjectsPropertyEditor : DXPropertyEditor, IComplexViewItem
    {
        ...
        private void TokenItem_Validating(object sender, CancelEventArgs e)
        {
            if (objectSpace is not null
                && sender is XenialTokenEdit edit
    ...
    public class XenialRepositoryItemTokenEdit : RepositoryItemTokenEdit
    {
        ...
        /// <autogeneratedoc />
        public new XenialTokenEdit OwnerEdit => (XenialTokenEdit)base.OwnerEdit;
        ...
        protected override void RaiseTokenAdded(TokenEditTokenAddedEventArgs e)
        {
            ...
            WasModified = true;
            if (OwnerEdit.EditValue is System.ComponentModel.BindingList<object> list

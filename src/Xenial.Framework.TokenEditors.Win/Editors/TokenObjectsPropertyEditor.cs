...
namespace DevExpress.ExpressApp.Editors
{
    ...
    public static class TokenObjectsPropertyEditorExtensions
    {
        ...
        /// <autogeneratedoc />
        public static EditorDescriptorsFactory UseTokenObjectsPropertyEditor(this EditorDescriptorsFactory editorDescriptorsFactory)
        {
            _ = editorDescriptorsFactory ?? throw new ArgumentNullException(nameof(editorDescriptorsFactory));
            editorDescriptorsFactory.RegisterPropertyEditorAlias(Xenial.Framework.TokenEditors.EditorAliases.TokenObjectsPropertyEditor, typeof(IEnumerable<>), true);
            editorDescriptorsFactory.RegisterPropertyEditor(typeof(IEnumerable<>), typeof(TokenObjectsPropertyEditor), false);

...
namespace Xenial.Framework.TokenEditors.Win.Editors
{
    ...
    public class TokenObjectsPropertyEditor : DXPropertyEditor, IComplexViewItem
    {
        ...
        protected override void SetupRepositoryItem(RepositoryItem item)
        {
            ...
            if (item is XenialRepositoryItemTokenEdit tokenItem && objectSpace is not null)
            {
                ...
                try
                {
                    ...
                    tokenItem.TokenRemoved += TokenItem_TokenRemoved;
                    tokenItem.TokenAdded += TokenItem_TokenAdded;
                }
                finally
                {
                    tokenItem.EndUpdate();
        ...
        private void TokenItem_TokenAdded(object sender, TokenEditTokenAddedEventArgs e)
        {
            wasModified = true;
        ...
        private void TokenItem_TokenRemoved(object sender, TokenEditTokenRemovedEventArgs e)
        {
            wasModified = true;

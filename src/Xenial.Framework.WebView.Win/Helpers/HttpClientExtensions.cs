...
/* Nicht gemergte Änderung aus Projekt "Xenial.Framework.WebView.Win(net5.0-windows)"
Vor:
...
/* Nicht gemergte Änderung aus Projekt "Xenial.Framework.WebView.Win(net6.0-windows)"
Vor:
namespace Xenial.Framework.WebView.Win.Helpers
{
    /// <summary>   Provides HttpClientExtensions for the System.Net.Http.HttpClient. </summary>

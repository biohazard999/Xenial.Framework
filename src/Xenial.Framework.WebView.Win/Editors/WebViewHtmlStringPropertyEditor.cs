...
namespace Xenial.Framework.WebView.Win.Editors
{
    ...
    public sealed partial class WebViewHtmlStringPropertyEditor : WinPropertyEditor
    {
        ...
        /// Xenial.Framework.WebView.Win.Editors.WebViewHtmlStringPropertyEditor and optionally releases
        ...
        protected override void LogValueStoring(object newValue) => DevExpress.Persistent.Base.Tracing.Tracer.LogText("{0} value changed.", nameof(WebViewHtmlStringPropertyEditor));
    }

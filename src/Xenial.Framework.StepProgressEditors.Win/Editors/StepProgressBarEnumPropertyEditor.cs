...
namespace Xenial.Framework.StepProgressEditors.Win.Editors
{
    ...
    [XenialCheckLicense]
    public sealed partial class StepProgressBarEnumPropertyEditor : WinPropertyEditor
    {
        /// <summary>
    ...
    /// <autogeneratedoc />
    [XenialCheckLicense]
    public sealed partial class XenialEnumStepProgressBar : StepProgressBar
    {
        private object? editValue;

        /// <summary>   Gets or sets the edit value. </summary>
        ///
        ...
        /// <summary>   Handles the <see cref="E:MouseMove" /> event. </summary>
        ///
        ...
        /// <summary>   Handles the <see cref="E:MouseClick" /> event. </summary>
        ///
        /// <param name="e">    The <see cref="System.Windows.Forms.MouseEventArgs"/> instance containing
        ///                     the event data. </param>
...
{
    /// <summary>   Class StepProgressBarEnumPropertyEditorWinExtensions. </summary>
    public static class StepProgressBarEnumPropertyEditorWinExtensions
    {
        /// <summary>   Uses the step progress enum property editors windows forms. </summary>
        ///
        /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
        ///                                             null. </exception>
        ///

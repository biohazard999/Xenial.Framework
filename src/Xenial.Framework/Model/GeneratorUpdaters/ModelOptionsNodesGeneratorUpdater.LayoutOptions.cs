...
namespace Xenial.Framework.Model.GeneratorUpdaters
{
    ...
    {
        /// <summary>   Specifies a string used to separate layout items and their captions. </summary>
        ///
        /// <value> The caption colon. </value>

        public string? CaptionColon { get; set; }

        /// <summary>   Specifies whether a colon is used in captions displayed for View Items. </summary>
        ///
        /// <value>
        /// <c>null</c> if [enable caption colon] contains no value, <c>true</c> if [enable caption
        /// colon]; otherwise, <c>false</c>.
        /// </value>

        public bool? EnableCaptionColon { get; set; }

        /// <summary>   Specifies the default layout group and item captions location. </summary>
        ///
        ...
        /// <summary>   Specifies the default layout group and item captions wrapping mode. </summary>
        ///
        ...
        ///
        /// <value>
        /// <c>null</c> if [enable layout group images] contains no value, <c>true</c> if [enable layout
        /// group images]; otherwise, <c>false</c>.
        /// </value>

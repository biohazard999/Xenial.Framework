...
public static partial class ModelNodesGeneratorUpdatersExtentions
{
    ...
    public static ModelNodesGeneratorUpdaters UseDeclareViewsGeneratorUpdater(this ModelNodesGeneratorUpdaters updaters)
    {
        _ = updaters ?? throw new ArgumentNullException(nameof(updaters));

        updaters.Add(new ModelViewsDeclareViewsUpdater());

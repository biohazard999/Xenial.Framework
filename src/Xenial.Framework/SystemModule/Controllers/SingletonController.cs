...
namespace Xenial.Framework.SystemModule
{
    ...
    /// <autogeneratedoc />
    public sealed class SingletonController : ViewController
    {
...
namespace DevExpress.ExpressApp
{
    ...
    public static class SingletonControllerExtensions
    {
        ...
        /// <autogeneratedoc />
        public static IEnumerable<Type> UseSingletonController(this IEnumerable<Type> types)
            => types.Concat(new[] { typeof(Xenial.Framework.SystemModule.SingletonController) });
    }
}

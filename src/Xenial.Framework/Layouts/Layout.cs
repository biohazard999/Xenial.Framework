...
namespace Xenial.Framework.Layouts
{
    ...
    public partial class LayoutBuilder
    {
        ...
        /// <summary>
        /// Tabs the specified identifier.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>LayoutTabGroupItem.</returns>
        /// <autogeneratedoc />
        public LayoutTabGroupItem Tab(string id)
            => LayoutTabGroupItem.Create(id);
        ...
        /// <returns>LayoutTabGroupItem.</returns>
        /// <autogeneratedoc />
        public LayoutTabGroupItem Tab(string id, FlowDirection flowDirection)
            => LayoutTabGroupItem.Create(id, flowDirection);
    }
}

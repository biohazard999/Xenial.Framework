...
public static partial class ModelBuilderExtensions
{
    ...
    ///
    /// <returns>   An IModelBuilder&lt;T&gt; </returns>
    ...
    /// <param name="builder">                      The builder. </param>
    /// <param name="modelDefaultPropertyName">     Name of the model default property. </param>
    /// <param name="modelDefaultPropertyValue">    if set to <c>true</c> [model default property
    ///                                             value]. </param>
    ///
    /// <returns>   An IModelBuilder&lt;T&gt; </returns>
    ...
    /// <summary>   Determines whether the specified image name has image. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether [has default property] [the specified property name]. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether [has default property] [the specified property]. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether [has object caption format] [the specified property]. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether [is not visible in reports]. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether [is visible in reports]. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether [is not visible in dashboards]. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether [is visible in dashboards]. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Withes the default class options. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Determines whether the specified class is singleton. </summary>
    ///
    /// <exception cref="ArgumentNullException">    Thrown when one or more required arguments are
    ///                                             null. </exception>
    ///
    ...
    /// <summary>   Withes the default ListView options. </summary>
    ///
    /// <exception cref="ArgumentNullException">    builder. </exception>
    ///
    /// <typeparam name="T">    . </typeparam>
    ...
    public static IModelBuilder<T> WithDefaultListViewOptions<T>(this IModelBuilder<T> builder, bool allowEdit, NewItemRowPosition newItemRowPosition)
    {
        _ = builder ?? throw new ArgumentNullException(nameof(builder));
        return builder.WithAttribute(new DefaultListViewOptionsAttribute(allowEdit, newItemRowPosition));
    }

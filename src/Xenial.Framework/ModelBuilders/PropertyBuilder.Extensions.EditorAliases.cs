...
namespace Xenial.Framework.ModelBuilders
{
    public static partial class PropertyBuilderExtensions
    {
        ...
        /// <summary>
        /// Uses the built-in alias for the DetailPropertyEditor
        /// </summary>
        /// <typeparam name="TClassType">The type of the t class type.</typeparam>
        /// <param name="builder">The builder.</param>
        /// <returns>IPropertyBuilder&lt;System.Nullable&lt;TimeSpan&gt;, TClassType&gt;.</returns>
        ...
        /// <summary>
        /// Uses the built-in alias for the Type Properties PropertyEditor.
        /// </summary>
        /// <typeparam name="TClassType">The type of the t class type.</typeparam>
        /// <param name="builder">The builder.</param>
        ...
        /// <summary>
        /// Uses the built-in alias for the VisibleInReportsTypePropertyEditor and ASPxVisibleInReportsTypePropertyEditor
        /// </summary>
        /// <typeparam name="TClassType">The type of the t class type.</typeparam>
        /// <param name="builder">The builder.</param>
        /// <returns>IPropertyBuilder&lt;System.Nullable&lt;Type&gt;, TClassType&gt;.</returns>
        ...
        /// <summary>
        /// Uses Specifies the built-in alias for the CriteriaPropertyEditor, AdvancedCriteriaPropertyEditor,
        ///     and ASPxCriteriaPropertyEditor editors. The static DevExpress.XtraEditors.WindowsFormsSettings.UseAdvancedFilterEditorControl
        ///     property determines which editor a WinForms application uses (DevExpress.Utils.DefaultBoolean.False
        ///     - for CriteriaPropertyEditor)
        /// </summary>
        /// <typeparam name="TClassType">The type of the t class type.</typeparam>
        /// <param name="builder">The builder.</param>
        /// <param name="objectTypeMemberName">Name of the object type member.</param>
        /// <param name="parametersMemberName">Name of the parameters member.</param>
        /// <returns>IPropertyBuilder&lt;System.Nullable&lt;Type&gt;, TClassType&gt;.</returns>
        ...
        /// <summary>
        /// Uses the built-in alias for the ExtendedCriteria Property Editor
        /// </summary>
        /// <typeparam name="TClassType">The type of the t class type.</typeparam>
        /// <param name="builder">The builder.</param>
        /// <param name="objectTypeMemberName">Name of the object type member.</param>
        ...
        /// <summary>
        /// Uses the built-in alias for the PopupCriteriaPropertyEditor and ASPxPopupCriteriaPropertyEditor
        /// </summary>
        /// <typeparam name="TClassType">The type of the t class type.</typeparam>
        /// <param name="builder">The builder.</param>
        /// <param name="objectTypeMemberName">Name of the object type member.</param>
        ...
        /// <summary>
        /// Uses the built-in alias for the ProtectedContentPropertyEditor and ASPxProtectedContentPropertyEditor
        /// </summary>
        /// <typeparam name="TClassType">The type of the t class type.</typeparam>
        /// <param name="builder">The builder.</param>
        /// <returns>IPropertyBuilder&lt;System.Nullable&lt;Type&gt;, TClassType&gt;.</returns>

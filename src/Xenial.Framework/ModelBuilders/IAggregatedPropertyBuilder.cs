...
{
    /// <summary>
    /// Interface IAggregatedPropertyBuilder Implements the
    /// <see cref="Xenial.Framework.ModelBuilders.IPropertyBuilder{TPropertyType, TClassType}" />
    /// </summary>
    ///
    ...
    {
        /// <summary>   Gets the property builders. </summary>
        ///

...
namespace Xenial.Framework.ModelBuilders
{
    ...
    /// <autogeneratedoc />
    [XenialCheckLicence]
    public partial class MultiplePropertyBuilder<TPropertyType, TClassType> : IPropertyBuilder<TPropertyType, TClassType>
    {
        private readonly IEnumerable<IPropertyBuilder<TPropertyType, TClassType>> propertyBuilders;

        /// <summary>
        /// Initializes a new instance of the <see cref="MultiplePropertyBuilder{TPropertyType, TClassType}"/> class.
        /// </summary>
        /// <param name="propertyBuilders">The property builders.</param>
        /// <exception cref="ArgumentNullException">propertyBuilders</exception>
        /// <autogeneratedoc />
        public MultiplePropertyBuilder(IEnumerable<IPropertyBuilder<TPropertyType, TClassType>> propertyBuilders)

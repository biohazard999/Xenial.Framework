...
{
    /// <summary>
    /// Class RemoveViewsModelBuilder.
    /// Implements the <see cref="Xenial.Framework.ModelBuilders.ModelBuilder{TClassType}" />
    /// </summary>
    /// <typeparam name="TClassType">The type of the t class type.</typeparam>
    /// <seealso cref="Xenial.Framework.ModelBuilders.ModelBuilder{TClassType}" />
    /// <autogeneratedoc />

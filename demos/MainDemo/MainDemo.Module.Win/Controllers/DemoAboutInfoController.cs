...
namespace Demo.Module.Win
{
    ...
    {
        private readonly SimpleAction demoAboutInfoAction;
        ...
        private void demoAboutInfoAction_Execute(object sender, SimpleActionExecuteEventArgs e) => DevExpress.Utils.About.AboutHelper.Show(DevExpress.Utils.About.ProductKind.XAF, new DevExpress.Utils.About.ProductStringInfo("DXperience Universal", "eXpressApp Framework"));
    }

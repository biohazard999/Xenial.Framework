...
namespace MainDemo.Module.Controllers
{
    public partial class PopupNotesController : ViewController
    {
        ...
        {
            var objectSpace = Application.CreateObjectSpace(typeof(Note));
            var noteListViewId = Application.FindLookupListViewId(typeof(Note));
            var collectionSource = Application.CreateCollectionSource(objectSpace, typeof(Note), noteListViewId);

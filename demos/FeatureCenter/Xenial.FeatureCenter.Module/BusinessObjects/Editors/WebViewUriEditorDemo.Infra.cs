...
namespace Xenial.FeatureCenter.Module.BusinessObjects.Editors
{
    ...
    public partial class WebViewUriEditorDemo
    {
        ...
        {
            new EditorInstallation("XenialWebViewModule", "UseWebViewUriPropertyEditor", null),
            new EditorInstallation("XenialWebViewWindowsFormsModule", "UseWebViewUriPropertyEditorWin", AvailablePlatform.Win),
            new EditorInstallation("XenialWebViewBlazorModule", "UseWebViewUriPropertyEditorBlazor", AvailablePlatform.Blazor),
        };
    }
}

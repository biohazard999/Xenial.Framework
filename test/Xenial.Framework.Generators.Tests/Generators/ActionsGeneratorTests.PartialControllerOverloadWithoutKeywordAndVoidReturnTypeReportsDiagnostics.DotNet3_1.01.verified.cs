...
namespace MyActions
{
    ...
    public partial class GeneratesSimpleActionWhenDefinedController : DevExpress.ExpressApp.ViewController
    {
        ...
        {
            return this.CreateGeneratesSimpleActionWhenDefinedActionCore();
        }
        
        private partial MyActions.GeneratesSimpleActionWhenDefined CreateGeneratesSimpleActionWhenDefinedActionCore();
